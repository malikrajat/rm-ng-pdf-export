...
This section documents any changes that may require modifications in consuming applications when upgrading `rm-ng-pdf-export`.
...
4. Validate PDF output and performance

---

## Summary

At present, upgrading within the same major version of `rm-ng-pdf-export` is safe.
